...
class ListItemMonitor(CommonMonitorFunctions):
    ...
    def get_item_identifier(self, position=0):
        # log("JON *listitem.py.get_item_identifier* El valor de 'IMDBNumber' es " + self.get_infolabel('IMDBNumber', position));
        # log("JON *listitem.py.get_item_identifier* El valor de 'dbid' es " + self.get_infolabel('dbid', position));
        # log("JON *listitem.py.get_item_identifier* El valor de 'dbtype' es " + self.get_infolabel('dbtype', position));
        # log("JON *listitem.py.get_item_identifier* El valor de 'property(Titulo)' es " + self.get_infolabel('property(Titulo)', position));
        # log("JON *listitem.py.get_item_identifier* El valor de 'tvshowtitle' es " + self.get_infolabel('tvshowtitle', position));
        # log("JON *listitem.py.get_item_identifier* El valor de 'title' es " + self.get_infolabel('title', position));
        # log("JON *listitem.py.get_item_identifier* El valor de 'year' es " + self.get_infolabel('year', position));
        # log("JON *listitem.py.get_item_identifier* El valor de 'season' es " + self.get_infolabel('season', position));
        # log("JON *listitem.py.get_item_identifier* El valor de 'episode' es " + self.get_infolabel('episode', position));
    ...
    def on_finalise_listcontainer(self, process_artwork=True, process_ratings=True):
        ...
        def _process_artwork_ratings():
            ...
            # log("JON *listitem.py._process_artwork_ratings* El valor de 'self._offscreen_li' es " + str(self._offscreen_li));
            # log("JON *listitem.py._process_artwork_ratings* El valor de '_pre_item' es " + _pre_item);
            # log("JON *listitem.py._process_artwork_ratings* El valor de 'self.cur_item' es " + self.cur_item);
